...
import { DEMO_DEFAULT_MEMBER, DEMO_HOUSEHOLD_POSTPARTUM, DEMO_HOUSEHOLD_PREGNANCY, demoHouseholds } from "@/fixtures/demo";
import { demoHasData, resetDemoState } from "./store";
import type { Session } from "./session";

export type DemoScenario = "pregnancy" | "postpartum";
...
export function demoSession(scenario: DemoScenario): Session {
  const householdId = scenario === "postpartum" ? DEMO_HOUSEHOLD_POSTPARTUM : DEMO_HOUSEHOLD_PREGNANCY;
